...
public class ArtsAdapter extends RecyclerView.Adapter<ArtsAdapter.ProductViewHolderownmake>
{
    ...
    public ArtsAdapter(Context mCtx, List<Faculty> productList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public ArtsAdapter.ProductViewHolderownmake onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_list, null);
        return new ArtsAdapter.ProductViewHolderownmake(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ArtsAdapter.ProductViewHolderownmake holder, final int position) {
        ...
        if(position==0) {
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("faculty", "Arts");
                    intent.putExtra("department", "bangla");
            ...
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, DepartmentInformationActivity.class);
                    intent.putExtra("faculty", "Arts");
                    intent.putExtra("department", "History");
                    context.startActivity(intent);
                }
            });
        }
            ...
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, DepartmentInformationActivity.class);
                    intent.putExtra("faculty", "Arts");
                    intent.putExtra("department", "Philosopy");
                    context.startActivity(intent);
                }
            });
        }
            ...
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, DepartmentInformationActivity.class);
                    intent.putExtra("faculty", "Arts");
                    intent.putExtra("department", "IslamicHistory");
                    context.startActivity(intent);
                }
            });
        }
