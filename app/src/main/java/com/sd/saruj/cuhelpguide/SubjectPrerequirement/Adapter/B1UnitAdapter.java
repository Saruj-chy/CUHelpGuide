...
public class B1UnitAdapter extends RecyclerView.Adapter<B1UnitAdapter.ProductViewHolderownmake>
{
    ...
    public B1UnitAdapter(Context mCtx, List<Faculty> productList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public B1UnitAdapter.ProductViewHolderownmake onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_list, null);
        return new B1UnitAdapter.ProductViewHolderownmake(view);
    }

    @Override
    public void onBindViewHolder(@NonNull B1UnitAdapter.ProductViewHolderownmake holder, final int position) {
