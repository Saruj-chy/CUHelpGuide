...
public class CUnitAdapter extends RecyclerView.Adapter<CUnitAdapter.ProductViewHolderownmake>
{
    ...
    public CUnitAdapter(Context mCtx, List<Faculty> productList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public CUnitAdapter.ProductViewHolderownmake onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_list, null);
        return new CUnitAdapter.ProductViewHolderownmake(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CUnitAdapter.ProductViewHolderownmake holder, final int position) {
