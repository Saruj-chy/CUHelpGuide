...
public class AUnitAdapter extends RecyclerView.Adapter<AUnitAdapter.ProductViewHolderownmake>
{
    ...
    public AUnitAdapter(Context mCtx, List<Faculty> productList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public AUnitAdapter.ProductViewHolderownmake onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_list, null);
        return new AUnitAdapter.ProductViewHolderownmake(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AUnitAdapter.ProductViewHolderownmake holder, final int position) {
