...
public class ScienceAdapter  extends RecyclerView.Adapter<ScienceAdapter.ProductViewHolderownmake>
{
    ...
    public ScienceAdapter(Context mCtx, List<Faculty> productList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public ScienceAdapter.ProductViewHolderownmake onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_list, null);
        return new ScienceAdapter.ProductViewHolderownmake(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ScienceAdapter.ProductViewHolderownmake holder, final int position) {
        ...
        if(position==0) {
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("faculty", "Science");
            ...
            holder.textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("faculty", "Science");
                    intent.putExtra("department", "appliedChemistry");
                    context.startActivity(intent);
                }
            });
        }
